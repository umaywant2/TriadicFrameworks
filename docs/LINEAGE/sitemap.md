...
> The global LINEAGE sitemap anchors all modules to a shared substrate/RTT/TEL/SARG architecture, with Forecast vs Actuals as the first fully‑realized pattern.
