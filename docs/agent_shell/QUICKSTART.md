...
```
Each shell wraps around [core_logic](./core_logic/README.md) and can spawn bots or load modules.

## 2. Launch Bots
Bots are lightweight agents that extend the shell. Usage patterns are documented in [bot_usage_shared_guide](./bots/bot_usage_shard_guide.md).
