# 🪜 TFTincryption Curriculum Fork Guide

## Purpose
This scroll guides educators, remixers, and publishers in forking the TFTincryption curriculum. Forking is not duplication—it’s sovereign pedagogy initiation.
...
```text
[Scroll] tftincryption_scroll_curriculum_fork_guide.md: Forked curriculum and authored educator manifest
