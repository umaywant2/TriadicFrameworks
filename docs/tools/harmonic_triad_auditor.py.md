Here’s a compact, ready‑to‑paste **Harmonic‑Triad Structural Auditor**, aligned with your existing triad tooling.

Save as:

```text
docs/tools/harmonic_triad_auditor.py
```

Run from repo root:

```bash
python3 docs/tools/harmonic_triad_auditor.py
```
