...
```text
docs/tools/record_canon_health_timeseries.py
```

Run from repo root:

```bash
python3 docs/tools/record_canon_health_timeseries.py
```

It will append snapshots to:

```text
docs/spine/canon_health_timeseries.json
```
