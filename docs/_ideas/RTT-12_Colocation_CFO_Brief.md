...
## 📄 `docs/_ideas/RTT-12_Colocation_CFO_Brief.md`
...
## 🌐 `docs/_ideas/RTT-12_for_Colocation.md`
...
# 3️⃣ Diagram Page Wiring

Create `docs/_ideas/diagrams/corridor_stabilization.md`:
...
Link it from the product page:
```markdown
See: [Corridor Stabilization Diagram](diagrams/corridor_stabilization.md)
```
