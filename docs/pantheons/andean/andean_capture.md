...
- High‑altitude cosmology and vertical archipelago patterns   [en.wikipedia.org](https://en.wikipedia.org/wiki/Andean_civilizations)
...
- **Ancestor** — lineage, burial, mummification traditions (Chachapoya, Inca)   [en.wikipedia.org](https://en.wikipedia.org/wiki/Andean_civilizations)  
...
- **Vertical archipelago patterns unify highland/lowland resource systems.**   [en.wikipedia.org](https://en.wikipedia.org/wiki/Andean_civilizations)  
...
It is fully consistent with the **Andean capture** currently open in your active tab   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/pantheons/andean/andean_capture.md).
...
- `andean_capture.md` — full RTT/1 operator capture  
- `cycle-diagram.svg` — cosmological cycle visualization  
- `operators.svg` — triadic operator grid  
- `geometry.svg` — vertical archipelago + Apu axis  
- `paradox-map.svg` — paradox‑axis mapping  
- `supersphere-fusion.svg` — Wari/Tiwanaku/Inca supersphere intersection  
- `Andean_Triadic_Profile.jpg` — pantheon profile image  
- `andean_module.json` — canonical metadata block
