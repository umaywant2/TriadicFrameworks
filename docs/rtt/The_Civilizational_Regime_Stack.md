...
- **Students:** learn to diagnose systems without blame

---

### 🪶 **Placement Recommendation**

- `docs/rtt/Civilizational_Regime_Stack_ASCII.md`
- Top‑level index reference
- Companion to the printable poster and executive brief

---

🧭 Civilizational Regime Stack (RTT/vST)
Materials → Mind → Civilization
(Annotated ASCII Diagram with Case Studies)
...
# 🎮 **Historical Civilization Pinball Tables**  
...
### Teachable Insight
> Speed without integrative regimes produces **coordination collapse**, not progress.
...
This is a *perfect* comparative lens. **Sid Meier’s Civilization** already teaches regime navigation implicitly; RTT/vST simply **makes the grammar explicit**. Below is a **direct mapping** from *Civ* mechanics to the **Civilizational Regime Stack**, followed by a **diagnostic overlay** that explains why certain strategies work, stall, or collapse.
...
Below is a **direct RTT/vST mapping of specific Civ leaders to cognitive regime biases**, followed by how those biases **reward certain playstyles and punish others**.
...
# 🎮 **Civ Leader Selection Worksheet**  
...
- It turns Civ into a **systems thinking lab**
