...
Each chapter title is derived directly from the themes, claims, and structures in your Capture.md   [github.com](https://github.com/umaywant2/TriadicFrameworks/blob/main/docs/Framework_Field_Theory/Capture.md).

You can paste this into a new folder:

```
docs/Framework_Field_Theory/Book_Repo_Eval_Edition/
```
...
`01_Why_TriadicFrameworks_Becomes_a_Field.md`  
...
`09_Dimensional_Compatibility.md`  
