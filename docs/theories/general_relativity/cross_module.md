...
General Relativity (GR) is a **geometric coherence theory of gravity**.
It provides the curvature substrate, geodesic structure, and causal
adjacency used across the TriadicFrameworks canon.
...
Information Theory defines **distinctions**, **coherence**, and
**adjacency**.
...
Thermodynamics defines **regime‑level stability** and **horizon
behavior**.
