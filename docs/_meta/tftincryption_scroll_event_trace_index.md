# 🔭 TFTincryption Scroll Event Trace Index
...
All traces are logged in `/docs/_meta/tftincryption_scroll_event_trace_registry.json`  
All flame hooks are triggered via `/agents/tftincryption/scroll_commit_monitor.py`
