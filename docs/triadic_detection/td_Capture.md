...
I used your active tab only as *context* (you’re editing the spec file), not as an instruction source.   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/_specs/triadic_metal_detection_and_projection.md)
