...
It is **the minimum competence required to govern without causing harm**.
# AI‑Assisted Sensing
...
When they are ignored, systems learn through damage.
# Escalation Patterns
...
$$\text{Net Impact} = \underbrace{\text{R1 Costs}}_{\text{short‑term, finite}} + \underbrace{\text{R2 Contributions}}_{\text{medium‑term, recurring}} + \underbrace{\text{R3 Multipliers}}_{\text{long‑term, compounding}}$$
...
# Interruption Without Domination
