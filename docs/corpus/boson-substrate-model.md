...
These metadata files do not define or modify the Boson Substrate Model itself. They exist solely to support citation, archival stability, and reproducibility of the published artifact.
## Abstract
