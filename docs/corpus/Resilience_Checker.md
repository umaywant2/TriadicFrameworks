...
**Resilience Checker** is a structured diagnostic surface — 108 canonical paradox analyses spanning logic, physics, computation, cosmology, and philosophy. Each paradox is treated as a structural stress test, not a contradiction to be eliminated. The module builds regime literacy progressively, culminating in a capstone arc that targets the hardest problems at the frontier of computation and emergence.

## Structure

The 108 analyses are arranged in a layered progression:

- **Early paradoxes** — Classical logic and philosophical cases; foundational regime literacy
- **Mid-tier paradoxes** — Physics, computation, and cosmological cases; cross-domain transfer
- **Capstone arc (101–108)** — Computation, modeling, emergence, and causation; the structural frontier

The capstone arc is deliberately open-ended — these are the paradoxes where SET decomposition reveals the most about the limits of the current framework.

## Navigation

Use `index.html` to browse all 108 analyses with filtering by domain, difficulty, and resolution status.

## Structural Philosophy

> Most paradoxes arise when structural laws, energetic constraints, and relational access are collapsed into a single frame.

The Resilience Checker operationalizes this principle across 108 cases. The diagnostic surface is complete; the interpretive work is open.

## How to Use for Training

| Stage | Activity |
|---|---|
| 1 | Read the paradox statement cold — no analysis |
| 2 | Apply SET decomposition before reading the canonical analysis |
| 3 | Compare your decomposition against the canonical version |
| 4 | Identify where your frame collapsed layers |
| 5 | Repeat until SET decomposition is reflexive |

## Relationship to Paradoxes Canon

`Paradoxes_canon` is the canonical reference — authoritative structural analysis. Resilience Checker is the training surface — worked examples for progressive regime literacy development. Use both.

## Integration Points

- `Paradoxes_canon` — Canonical reference underpinning all 108 analyses
- `Structural_Detection` — SD operators (DRIFT_SENSE, REGIME_AWARENESS) are trained on Resilience Checker patterns
- `Framework_Field_Theory` — FFF lattice is the geometric space in which all 108 stress tests are mapped
...
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_01_EPR_Paradox.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_02_Gibbs_Paradox.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_04_Halting_Problem.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_06_Frame_Problem.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_08_Currys_Paradox.md)*
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_09_Chinese_Room.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab — GitHub editor)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/new/main/docs/Resilience_Checker)
...
# 🧩 Paradox 102 — Computational Complexity vs. Physical Realizability  
...
- Useful for teaching complexity theory, quantum computing, and physics‑based computation.
# 🧩 Paradox 103 — Analog Continuity vs. Digital Precision  
...
- Useful for teaching numerical analysis, analog computing, and measurement theory.
...
# 🧩 Paradox 105 — Simulation Accuracy vs. Physical Fidelity  
### *If simulations can approximate physical systems arbitrarily well, why can’t they perfectly reproduce real‑world behavior?*  
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab —   [github.com](https://github.com/umaywant2/TriadicFrameworks/new/main/docs/Resilience_Checker))*
...
- Useful for teaching numerical analysis, simulation theory, and computational physics.
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_10_Infinite_Regress_Justification.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_13_Quantum_Zeno.md)
...
### RTT Paradox Resilience Checker — Candidate File  
*(Source: your active tab)*   [github.com](https://github.com/umaywant2/TriadicFrameworks/edit/main/docs/Resilience_Checker/Paradox_19_Quantum_Eraser.md)
...
# 🧩 Paradox 50 — Mathematical Universe vs. Physical Universe  
...
- Useful for teaching philosophy of physics, metaphysics, and mathematical ontology.
# 🧩 Paradox 51 — Computability vs. Continuum Reality  
...
- Useful for teaching philosophy of computation, mathematical physics, and ontology.
...
# 🧩 Paradox 76 — Quantum Error Correction vs. Physical Locality  
...
# 🧩 Paradox 88 — Eternal Inflation vs. Global Unitarity  
...
2. **No drama** — the horizon is smooth for infalling observers  
3. **Local quantum field theory** — physics outside the horizon is normal  
...
- **By domain** — using the section groupings in `index.html`  
- **By failure mode** — tracing recurring themes like irreversibility, observer dependence, or scale mismatch  
...
- `Paradox_01_…` through `Paradox_108_…`  
  Canonical paradox analyses, one file per paradox  
- `Meta_Summary_Paradoxes_101–108.md`  
  A one‑page synthesis of the final computational–emergence arc  
- `index.html`  
  A navigable, human‑readable map of the collection  
- `DOC_MAP` (embedded or referenced)  
