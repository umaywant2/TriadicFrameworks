rtt_Stability_Basin_Cartographer 
...
<img width="1194" height="672" alt="rtt_Stability_Basin_Cartographer" src="https://github.com/user-attachments/assets/d4c704b6-e932-4337-b1cf-b328cae7e1d2" />
...
### **Core**
- `Stability_Basin_Cartographer.md`  
- `sbc_examples.md`  
- `sbc_diagrams.svg`  

### **Support**
- `stability_basin_profiles.md`  
- `basin_collapse_cases.md`  
- `stability_field_matrix.json`  
