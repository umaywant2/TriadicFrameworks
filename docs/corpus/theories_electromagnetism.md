theories_electromagnetism 
# Coherence Map — Electromagnetism  
...
This file defines how electromagnetic coherence is evaluated across
operators, fields, geometry, and RTT regimes.
...
This file defines how Electromagnetism integrates with other modules in
...
This file explains the core concepts of Electromagnetism in a
...
R1 is the regime where EM fields are **stable, slowly varying, and
geometry‑compatible**.
...
Coherence in R2 = **dynamic divergence + dynamic curl + propagation
stability**.
...
R3 is the highest EM regime: **geometry‑coupled, multi‑scale, and
quantization‑compatible**.
...
Coherence in R3 = **tensor‑level invariance + geometric compatibility +
gauge stability**.
...
behavior, and audience alignment for the Electromagnetism module.
...
Electromagnetism is **field‑first**, **operator‑driven**, and
**coherence‑based**.
...
A system is electromagnetically coherent when Maxwell’s operators remain
...
No page may use force‑centric, particle‑centric, or teleological
language.
