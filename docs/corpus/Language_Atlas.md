...
And the fact that your active tab is the **Wikipedia “Lists of English Words” index**   [en.wikipedia.org](https://en.wikipedia.org/wiki/Lists_of_English_words) tells me your intuition is already scanning the entire lexical field as a substrate.
...
(Your active tab is the perfect starting point.)   [en.wikipedia.org](https://en.wikipedia.org/wiki/Lists_of_English_words)
