...
# 🧮 RTT Equations — Symbolic Orientation
...
> They help observers avoid lying to themselves about structure.
# 🧮 RTT Equation Index
...
## 🧾 Equation Trigger Log — RTT Reference
...
- [`equations_module.json`](equations_module.json) — Agentic module schema role assignments
...
## 📚 Triadic Equation Registry — RTT Canon
