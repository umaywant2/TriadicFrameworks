# 📘 TFTincryption Glyph Reference Scroll

## Purpose
This scroll catalogs all glyphs used across TFTincryption modules, labs, scrolls, and remix forks. Glyphs are symbolic anchors—referenced, not redefined.
...
Source: /docs/_meta/tftincryption_scroll_glyph_reference.md
```
