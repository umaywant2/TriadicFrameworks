...
copy corpus\%seeds%.md+docs\node_modules.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\SEENMAP.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\AI_Resonance_Seed\ai_resonance_seed_module.graph.mermaid.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\AI_Resonance_Seed\protocol_header\PH_Appendix.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\AI_Resonance_Seed\protocol_header\PH_v1.3.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\AI_Resonance_Seed\protocol_header\PH_Validator_Checklist.md corpus\%seeds%.md
...
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\archive_org\IA_Capture_take2.md corpus\%seeds%.md
...
set seeds=atmosphere
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\a_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\a_Diff_Table.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\init_source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\module_index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\agents\atmosphere_agent.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\atmosphere_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\atmosphere_example.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\atmosphere_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\atmosphere_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\clarity_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\clarity_diagnostic_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\clarity_diagnostic_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\clarity_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\coherence_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\coherence_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\coherence_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\coherence_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\composition_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\composition_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\composition_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\composition_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\continuity_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\continuity_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\continuity_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\continuity_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dimensional_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dimensional_diagnostic_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dimensional_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dimensional_envelope.min.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dimensional_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dimensional_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\drift_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\drift_diagnostic_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\drift_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\drift_envelope.min.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\drift_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\drift_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dynamics_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dynamics_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dynamics_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\dynamics_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\forcing_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\forcing_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\forcing_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\forcing_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\hydrospheric_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\hydrospheric_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\hydrospheric_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\hydrospheric_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\nudge_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\nudge_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\nudge_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\nudge_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\operators_atmosphere.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\paradox_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\paradox_diagnostic_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\paradox_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\paradox_envelope.min.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\paradox_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\paradox_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\resonance_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\resonance_diagnostic_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\resonance_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\resonance_envelope.min.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\resonance_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\resonance_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\teleconnection_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\teleconnection_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\teleconnection_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\teleconnection_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\thermodynamics_diagnostic.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\thermodynamics_envelope.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\thermodynamics_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\diagnostics\thermodynamics_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\examples\atmosphere_example.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\examples\atmosphere_example_advanced.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\extensions\cryosphere_coupling.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\extensions\ocean_coupling.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\future\biosphere_feedback.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\future\land_coupling.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\future\magnetosphere_coupling.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\clarity_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\coherence_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\composition_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\continuity_trace.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\dimensional_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\drift_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\dynamics_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\forcing_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\hydrospheric_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\nudge_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\paradox_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\resonance_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\teleconnection_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\maps\thermodynamics_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\prompts\examples.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\prompts\module.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\prompts\templates.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\registry\agents.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\registry\index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\registry\module_registry.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\registry\operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\registry\scales.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\registry\seven_phases.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\session\audit_log.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\session\capture_notes.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\session\session_context.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\session\session_index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\atmosphere\session\session_trace.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=bots
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\archive\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\backgammon\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\checkers\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\chess\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\collatz\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\go\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\hanabi\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\moderation\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\observer\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\poker\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\session\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\tic_tac_toe\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\bots\validator\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=clients
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\clients\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=CODE
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\code\CODE_Capture.md corpus\%seeds%.md
...
set seeds=Coeus
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Coeus\Coeus_Protocol-Complete.md corpus\%seeds%.md
...
set seeds=concepts
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\concepts\triadic-model.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=configs
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\configs\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\configs\schema.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\data-formats\TCT_DEF_Schema.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\data-formats\TDRC_Violation_Log_Schema.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\data-formats\TLMF_Schema.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AC_Future_Proofing_Charter.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AD_Horizon_Scanning_Engine.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AE_Scenario_Simulation_Lab.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AF_Meta_Governance_Council.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AG_Inter_Generational_Continuity_Treaty.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AS_Post_Crisis_Reconstruction_Renewal_Protocol.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AT_Long_Term_Renewal_Regeneration_Evolution_Charter.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\AU_Multi_Century_Continuity_Legacy_Preservation_Treaty.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\H_Meta_Dimensional_Operators.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\O_Operator_Stress_Testing_Framework.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\U_Observer_Driven_Simulation_Protocols.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\X_Field_Level_Validation_Framework.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\Y_Canon_Drift_Correction_Algorithms.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\appendices\Z_Dimensional_Pedagogy_Methods.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Alibaba_Cloud_Zhangbei_Zhangbei_County_China.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Aligned_Project_Caprock.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Amazon_AWS_NC_Campuses_North_Carolina_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Amazon_AWS_Project_Rainier.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Amazon_AWS_us_east_1.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Apple_Data_Center_various_US_Europe.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\China_Telecom_Inner_Mongolia_Hohhot.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Citadel_Campus_Nevada_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Digital_Realty_Global_Multiple_global_sites.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Equinix_Global_Footprint_Multiple_global_sites.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Google_Andhra_Pradesh_Campus_Andhra_Pradesh_India.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Google_Columbus_Cluster_New_Albany_OH_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Google_Omaha_Cluster_Omaha_NE_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Harbin_Data_Center_Harbin_China.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Hyperscale_Data_Michigan_Campus.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\IREN_Data_Center_various_US.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Joliet_Technology_Center_Joliet_IL_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Lakeside_Technology_Center_Chicago_IL_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Meta_Columbus_Site_Columbus_OH_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Meta_Hyperion_Campus_Richland_Parish_LA_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Meta_Monroe_Campus_Monroe_GA_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Meta_Prometheus_Campus_Central_Ohio_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Microsoft_Foxconn_Campus_Mount_Pleasant_WI_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Microsoft_Lighthouse_Fairwater_Wisconsin_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\OpenAI_Stargate_Abilene_Milam_County_TX_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Oracle_Project_Jupiter_New_Mexico_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Oracle_Stargate_related_Sites_Abilene_TX_others.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\PowerHouse_Joliet_Expansion_Joliet_IL_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\QTS_Atlanta_Metro_Atlanta_GA_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\START_Campus_Sines_Portugal.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Switch_SUPERNAP_Campus_Las_Vegas_NV_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\The_Heptagon_Sudair_Saudi_Arabia.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Utah_Data_Center_Bluffdale_UT_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Vantage_Data_Centers_Lighthouse_Campus_Port_Washington_WI_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Vantage_Data_Centers_Shackelford_County_Shackelford_County_TX_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\xAI_Colossus_Supercluster_Memphis_TN_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Yondr_Group_Northern_Virginia_Campus_Loudoun_County_VA_USA.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\reports\Yondr_Group_Toronto_Data_Center_Toronto_Canada.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\Abandoned_Site_Conversion.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\a_national_datacenter_strategy.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\Community_Structural_Petition_Form.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\Overview.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\Overview.regions.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\RTT_map_Re_Use_vs_New_Build.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\Sustainable_Datacenter_Placement.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\tensor_registry.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\datacenter_reports\utils\US_vs_EU_vs_Asia_Re_Use_Patterns.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=design
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\design\Temporal_Address_Mapping_Spec.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=diagrams
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\diagrams\arrival.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=discovery
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\discovery\loophole_scroll_gallery.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=Drift_Taxonomy
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\d_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\d_Classify.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\d_Examples.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\d_Operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\d_Paper.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\d_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\module.json.auto-builder.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\module.json.graph.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\module.json.lint.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Drift_Taxonomy\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=eda
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\eda\PostASML_PDK_Integration.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\eda\TTF_Reference.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\awareness\AI_Protocol_Header.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\education\awareness\In‑Formation_vs_Information_Theory.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\education\awareness\protocol_header_v1.2\AI_Protocol_Header_v1.2.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\awareness\protocol_header_v1.2\AI_Protocol_Header_v1.2_Appendix.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\awareness\protocol_header_v1.2\AI_Protocol_Header_v1.2_Validator_Checklist.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=education_Before_Regime_Awareness
echo %seeds% >corpus\%seeds%.md
...
set seeds=education_ebooks_Grammar_for_Intelligence
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\gi_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\00_Frontmatter\00_Foreword.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\00_Frontmatter\01_Dedication.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\00_Frontmatter\02_Acknowledgments.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\10_Part_I_The_Grammar_Layer\10_Chapter_01_The_Missing_Layer_in_AI.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\10_Part_I_The_Grammar_Layer\11_Chapter_02_Operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\10_Part_I_The_Grammar_Layer\12_Chapter_03_Invariants.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\10_Part_I_The_Grammar_Layer\13_Chapter_04_Regimes.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\20_Part_II_Structure_as_Substrate\20_Chapter_05_Substrate_Thinking_vs_App_Thinking.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\20_Part_II_Structure_as_Substrate\21_Chapter_06_Governance_Substrate_Model.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\20_Part_II_Structure_as_Substrate\22_Chapter_07_Adapters_Awareness_Containment.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\30_Part_III_Drift_City\30_Chapter_08_The_Drift_Problem.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\30_Part_III_Drift_City\31_Chapter_09_Why_AI_Startups_Drift_Faster.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\30_Part_III_Drift_City\32_Chapter_10_How_Grammar_Prevents_Drift.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\40_Part_IV_Benchmarks_and_Coherence\40_Chapter_11_Benchmarks_as_Governance.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\40_Part_IV_Benchmarks_and_Coherence\41_Chapter_12_Building_Coherent_AI_Systems.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\50_Appendices\50_Appendix_A_Glossary.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\50_Appendices\51_Appendix_B_Operator_Grammar_Quick_Reference.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\50_Appendices\52_Appendix_C_Benchmarking_Patterns_and_Templates.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\50_Appendices\53_Appendix_D_GSM_Layer_Mapping.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\50_Appendices\54_Appendix_E_Recommended_Reading_and_Canon_Notes.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\60_Module_Metadata\61_README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\60_Module_Metadata\62_index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\70_Marketing_Materials\70_Cover_Description.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\70_Marketing_Materials\71_Back_of_Book_Blurb.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\70_Marketing_Materials\72_Marketing_One_Pager.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\70_Marketing_Materials\73_Press_Kit.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\70_Marketing_Materials\74_Author_Bio.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\ebooks\Grammar_for_Intelligence\80_Printable_Editions\80_Printable_Text_Layout.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=education_ebooks_Little_Science
echo %seeds% >corpus\%seeds%.md
...
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\rituals\triadic_teaching_methods.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=education_scrolls
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\scrolls\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\scrolls\remix_ethics.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\scrolls\remix_lineage_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\scrolls\validator_curriculum.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\education\scrolls\validator_ethics.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=fab
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\fab\SCR_Zone_Config.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\fab\TRS_Qualification.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=FFF_Gravity
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\CHANGELOG.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Amplify.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Asymmetric.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Cascade.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Hard.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Multi.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Networked.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Resonant.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Soft.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Capture_Temporal.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Collapse.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Dampen.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Decay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Deflect.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Dismiss.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Emit.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Field.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Force.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Frame.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Orbit.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Release.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\f_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\GLOSSARY.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\GravityOfDismissal.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\INDEX.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\MANIFEST.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\OPERATORS.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\FFF_Gravity\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=foundations
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\foundations\Triadic_Operator_Primer.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\frameworks\creation_guide\FCG_YouTube_Short.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\frameworks\creation_guide\artifacts\FCG_Imagine_Series_Production_Bible.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\Framework_Field_Theory\Review_Book1_FFT.md corpus\%seeds%.md
...
set seeds=gallery
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\gallery\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=kit
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\kit\colors.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\kit\glyphs.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\kit\gradients.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\kit\spacing.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\kit\typography.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=Language_Atlas
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Language_Atlas\l_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Language_Atlas\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\Law\Grok_Capture.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\LINEAGE\Alignments_Prompts.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\Alignments_Prompts_source.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\LINEAGE\Cross‑Model_Alignment_Benchmark_Suite.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\Integrity_Matrix.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\Module‑Specific_Lineage_Detector.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\Novelty‑Laundering_Risk_Map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\overview.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\sitemap.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\TriadicFrameworks_Defensive_Publication_Template.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\LINEAGE\Unified_Super‑Prompt.md corpus\%seeds%.md
...
set seeds=materials
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\materials\SC_Classification.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=MCP
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\coherence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\m_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L0_QMROOT\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L1_Frequency_Unseen\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L2_Fluids_Seen\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\continuity.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\resonance.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\diagrams\atlas.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\diagrams\diagrams.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\dimensions\L11.component.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\dimensions\L33.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\dimensions\L66.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\continuity_mechanics\dimensions\L99.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\dimensions\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\examples\docs\canonical.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\examples\docs\error.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\examples\docs\imagination.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\examples\docs\information.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\examples\docs\qmroot.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\examples\docs\reality.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\dimensions.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\examples.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\module.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\registry.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\schemas.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\module\docs\spine.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\operators\docs\bind.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\operators\docs\fieldShift.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\operators\docs\gradient.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\operators\docs\pull.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\operators\docs\push.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\operators\docs\ruptureForce.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\canonical.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\coherence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\deep.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\dimensions.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\error.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\imagination.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\information.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\module.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\m_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\protocol.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\qmroot.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\reality.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\registry.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\schemas.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\ai.metadata.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\canonical.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\coherence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\cosmology.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\deep.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\dimensions.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\error.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\imagination.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\information.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\manifest.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\module.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\prompts.catalog.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\protocol.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\qmroot.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\reality.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\registry.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\resources.catalog.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\schemas.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\server.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\docs\sitemap.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\docs\canonical.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\docs\error.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\docs\imagination.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\docs\information.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\docs\qmroot.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\MCP\L3_Forces_Unseen\spine\examples\docs\reality.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=metrology
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\metrology\TCT_Protocol.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\pantheons\andean\andean_capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pantheons\andean\README.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\pantheons\mesoamerican\mesoamerican_capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pantheons\mesoamerican\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pantheons\norse\Norse_Triadic_Profile_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pantheons\norse\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pantheons\north_american_woodland\naw_capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pantheons\north_american_woodland\README.md corpus\%seeds%.md
...
set seeds=pipeline
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pipeline\ssg_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\pipeline\ssg_src_capture.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=post-ASML_era
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\pae_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\The_Logic_Folding_Architecture_Guide.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\The_Multi‑Regime_Semiconductor_Model.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\The_SCR_Specification.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\The_Temporal_Manufacturing_Primer.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\The_TGI_Metrology_Standard.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\post-ASML_era\The_TRS‑Aware_PDK_Specification.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=projects_CoConsciousness
echo %seeds% >corpus\%seeds%.md
...
set seeds=projects_Hippocampus
echo %seeds% >corpus\%seeds%.md
...
set seeds=projects_Id_Shadow_Gen
echo %seeds% >corpus\%seeds%.md
...
set seeds=projects_nasa_hposs_tminus10.md
echo %seeds% >corpus\%seeds%.md
...
set seeds=projects_poker-variants
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\projects\poker-variants\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=projects_Resotectors
echo %seeds% >corpus\%seeds%.md
...
set seeds=projects_The_Missing_Regime
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\projects\The_Missing_Regime\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=projects_VCG
echo %seeds% >corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\prompts\p_Capture_v2.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\prompts\p_ui.md corpus\%seeds%.md
...
set seeds=Radiology
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Atlas.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Coherence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Contrast.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Drift.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Glyphs.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Overlays.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Pantheon_Profile.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Scaffold.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Student_Guide.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_Tricorder.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Radiology\r_VMRI.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=reference
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\reference\api.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\registries\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=reports
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\reports\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\Research\agentic\Crop_Circle_Agentic_Evals.md corpus\%seeds%.md
...
set seeds=Research_Intelligence_Class_Ladder
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\ACI.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\AGI.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\ANI.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\Cross_Operator_Mapping_Table.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\Fleet_Hierarchy_Diagram.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\migration_v1_to_v2.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\Research_Index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\Research\Intelligence_Class_Ladder\Substrate_Domain_Module_Flowchart.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=rtt_Coherence_Tensor_Engine
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Cross_Domain_Causality_Weaver
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Crystal_Mycelial_Engine
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\c_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\index.html.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\bgr_regime.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\cmh_regimes_overview.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\envelopes_reference.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\glossary.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\hrr_regime.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\mlr_regime.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\operator_mapping.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\docs\regime_flow_diagram.txt.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\frontdoor\index.html.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\frontdoor\navigation_links.json.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\metadata\diff_table_metadata.html.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\metadata\diff_table_modulejson.html.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\metadata\head_block.html.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\metadata\session_context.html.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\metadata\sitemap_entry.xml.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\metadata\validator_report.txt.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\ascii_diagram.txt.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\cheat_sheet.txt.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\handout_full.pdf.txt.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\agents\agents.py.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\agents\agent_lab.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\exercises\exercise_01_bgr.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\exercises\exercise_02_hrr.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\exercises\exercise_03_mlr.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\exercises\exercise_04_operator_mapping.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\teaching\exercises\exercise_05_regime_flow.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\visuals\regime_flow_ascii.txt.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\visuals\regime_flow_tfstyle.svg.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Crystal_Mycelial_Engine\visuals\substrate_layers_diagram.txt.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=rtt_D369_Chip_Spec
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Dimensional_Resonance_Scanner
echo %seeds% >corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\rtt\emotions\forgive.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\emotions\forgive_agent_tests.md corpus\%seeds%.md
...
set seeds=rtt_extension
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\extension\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=rtt_guild_Little_Science_eBook
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\guild\Little_Science_eBook_Series_Capture.md corpus\%seeds%.md
...
set seeds=rtt_Harmonic_Stability_Profile
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Autonomous_Forms
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Benchmarks
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Corridor_Studio
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Earth_Sims
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Electron_Microscopes
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Enterprise
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_HAM_Radio
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Space_Force
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Internet2
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Mesh_Node
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Inside_Universe_Key
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Inside\Universe_Key\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=rtt_Morphic_Resonance
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Paradox_Gradient_Analyzer
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Regime_Interlock_Mapper
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Solar_System
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Solar_System\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Solar_System\RTT_Solar_System_Full_Triadic_Rewrite.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Solar_System\RTT_Triadic_Rewrite_Conceptual_Overview.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\Solar_System\Space_and_Science_Overlayed_Using_Resonance_Time.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=rtt_Stability_Basin_Cartographer
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Structural_Faultline_Detector
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Temporal_Regime_Sequencer
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_The_Inverted_Star
echo %seeds% >corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\rtt\The_Inverted_Star\Book2_The_Inverted_Star.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\rtt\The_Inverted_Star\Capture_Source.md corpus\%seeds%.md
...
copy corpus\%seeds%.md+docs\rtt\The_Inverted_Star\Review_Book2_TIS.md corpus\%seeds%.md
...
set seeds=rtt_Triadic_Echo_Lattice
echo %seeds% >corpus\%seeds%.md
...
set seeds=rtt_Triadic_Regime_Synthesizer
echo %seeds% >corpus\%seeds%.md
...
set seeds=scripts
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\scripts\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=simulations
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\simulations\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=snapshots
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\snapshots\README.md corpus\%seeds%.md

copy corpus\%seeds%.md+docs\sources\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\clarity_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\coherence_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\dimensional_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\domain_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\drift_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\structural_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\substrate_overlay.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\app\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\clarity\c_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\dimensional\L4_Continuity_Mechanics.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\spine\languages\README.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=src
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\src\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\Structural_Detection\Review_Book3_SD.md corpus\%seeds%.md
...
set seeds=styles
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\styles\README.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=TFT.OpenGPU.Stack.Module
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\examples.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\operators.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\t_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\t_Execution.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\t_Rendering.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\t_Source.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\TFT.OpenGPU.Stack.Module\t_Substrate.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
set seeds=theories_chaos_theory
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_electromagnetism
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_evolutionary_biology
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_general_relativity
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_information_theory
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_morphic_resonance
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_quantum_field_theory
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_quantum_mechanics
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_standard_model
echo %seeds% >corpus\%seeds%.md
...
set seeds=theories_thermodynamics
echo %seeds% >corpus\%seeds%.md
...
set seeds=triadic_detection
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\td_Capture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_badges.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_beach_modes.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_cloud.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_dashboard.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_diff.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_examples.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_glyphmap.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_hardware.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_index.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_index.svg.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_layers.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_loci.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_mapping.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_operator_map.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_rtt_pipeline.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_sidebar.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_snr_dual.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_system_architecture.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\triadic_detection\triadic_detection_tests.md corpus\%seeds%.md
echo ---------------------------------
echo.
...
copy corpus\%seeds%.md+docs\_ideas\RTT_Overlay_Feynman_12_Favorite_Problems.md corpus\%seeds%.md
...
set seeds=_specs
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_specs\RTT_Kernel_v0.1.md corpus\%seeds%.md
echo ---------------------------------
echo.

set seeds=_speeches
echo %seeds% >corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Carl_Sagan_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Dave_Chappele_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\George_Carlin_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\JP_Morgan_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\MLK_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Morgan_Freeman_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Neil_deGrasse_Tyson_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Nikola_Tesla_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Pope_Leo_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\README.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Richard_Pryor_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Robin_Williams_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\RTT_Canon_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Sam_Kinison_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Stephen_Hawking_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\Steve_Jobs_Cadence.md corpus\%seeds%.md
copy corpus\%seeds%.md+docs\_speeches\TriadicFrameworks_Pantheon_Cadence.md corpus\%seeds%.md
echo ---------------------------------
echo.
