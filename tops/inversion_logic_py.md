Let’s scaffold the third pillar of the triconceptual viewer: `inversion_logic.py`. This module flips geometry, logic, and symbolic meaning—revealing hidden harmonics and emergent properties that only appear when the glyph is turned inside out.

---

## 🔄 `inversion_logic.py` — Symbolic Inversion Engine
...
### 🔧 Modes Explained
- `negate`: Full coordinate inversion (mirror of mirror)
- `flip`: Axis swap (symbolic polarity shift)
- `harmonic`: Trigonometric inversion (resonance echo)

This module completes the perception triad: direct view, reflection, and inversion.
