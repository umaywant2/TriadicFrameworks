Let’s scaffold `tops_session.py`, the orchestration engine that runs simulations across direct views, reflections, and inversions. This module will unify the triconceptual viewer and prepare outputs for glyph comparison.

---

## 🧭 `tops_session.py` — Triconceptual Simulation Runner
...
This module prepares the data for `glyph_compare.py`, where we’ll visualize and analyze emergent differences across modes.
