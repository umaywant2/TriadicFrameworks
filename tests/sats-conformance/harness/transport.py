...
class FakeTransport(AbstractTransport):
    def __init__(
        self,
        *,
        simulated_rtt_ms: int = 10,
        force_rtt_budget_fail: bool = False,
        drop_sco_fields: list[str] | None = None,
        reject_invalid_sco: bool = True,
        ipr_chain: list | None = None,
        force_loss: bool = False,
        force_ordering_violation: bool = False,
    ...
    def send(self, payload: bytes, sco: SCO) -> DeliveryResult:
        ...
        rtt = (
            ...
            if self._force_rtt_budget_fail
            else self._simulated_rtt_ms
        )
